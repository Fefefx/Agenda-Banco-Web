...
<html>
    ...
    <body>
        <form method="post" action="validausuario.jsp" class="user">
            <%
                String usuario = request.getParameter("user");
                if (usuario != null && !usuario.equals("none")) {
                    out.println("<p>Login:&nbsp;&nbsp;<input type='text' size='20' name='user' required='required' value='"+usuario+"'></p>");
                    out.println("<p>Senha:&nbsp;&nbsp;<input type='password' size='20' name='password' required='required'></p>");
                }else{
               %>
